...
export default function FavoritesCard({ title }: { title: string }) {
    ...
    return (
        <div id="favcard" ref={favcardref} className="flex w-full items-center justify-between py-2 px-3 my-1 bg-gray-100 rounded-s-full" style={{ 'boxShadow': 'rgba(0, 0, 0, 0.25) 0px 5px 5px, rgba(0, 0, 0, 0.12) 0px -5px 10px, rgba(0, 0, 0, 0.12) 0px 5px 2px'}}>
