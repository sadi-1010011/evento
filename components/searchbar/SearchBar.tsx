    ...
    return (
        <div className="my-2 flex flex-row justify-evenly w-full">
            <div className={`py-2 px-3 rounded-full bg-white w-full flex flex-row items-center overflow-hidden ${styles.searchbar}`}>
                ...
                <input  onChange={ (event) => changeSearchText(event.currentTarget.value) } className="px-3 text-lg text-black border-none outline-none font-semibold" type="text" placeholder={placeholder} value={searchtext} />
            </div>
