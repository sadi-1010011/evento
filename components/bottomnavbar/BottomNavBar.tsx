...
export default function BottomNavBar({ active = 'Explore'}) {
    ...
    return (
        <div style={{ boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }} className="flex fixed bottom-0 left-0 right-0 bg-white text-black dark:bg-slate-300 rounded-md z-30 w-full flex-row items-center justify-evenly ">

            <div onClick={ () => changeActiveTab('Explore') } className={`flex w-full rounded-md flex-col items-center pb-1 pt-2 transition-all dark:bg-white dark:text-black hover:bg-slate-400 hover:text-white ${ activeTab  === 'Explore' ? 'font-bold bg-slate-300' : 'font-normal' }`}>
            ...
            <div onClick={ () => changeActiveTab('Favorites') } className={`flex w-full rounded-md flex-col items-center pb-1 pt-2 transition-all dark:bg-white dark:text-black hover:bg-slate-400 hover:text-white ${ activeTab === 'Favorites' ? 'font-bold bg-slate-300' : 'font-normal' }`}>
            ...
            <div onClick={ () => changeActiveTab('Catogory') } className={`flex w-full rounded-md flex-col items-center pb-1 pt-2 transition-all dark:bg-white dark:text-black hover:bg-slate-400 hover:text-white ${ activeTab === 'Catogory' ? 'font-bold bg-slate-300' : 'font-normal' }`}>
            ...
            <div onClick={ () => changeActiveTab('Profile') } className={`flex w-full rounded-md flex-col items-center pb-1 pt-2 transition-all dark:bg-white dark:text-black hover:bg-slate-400 hover:text-white ${ activeTab === 'Profile' ? 'font-bold bg-slate-300' : 'font-normal' }`}>
