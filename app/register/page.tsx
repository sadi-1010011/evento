...
export default function RegisterPage() {
    ...
    return (
        <div className="flex items-center justify-center w-full h-screen pt-3 px-2">
            ...
            <div className="flex flex-col items-center justify-center w-full sm:w-4/5 md:w-4/5 mx-2 px-4 py-8 bg-white text-black rounded-3xl shadow-xl">
                ...
                <form action={ () => handleSubmit() } className="w-full flex flex-col gap-2 items-center justify-center my-4 py-2 px-2">
                    <div className="flex gap-1">
                        <input onChange={ handleFirstname } className="bg-zinc-300 w-1/2 focus:border-2 rounded-l-full py-2 px-5 outline-none" type="text" placeholder="First Name" value={firstname} />
                        <input onChange={ handleLastname } className="bg-zinc-300 w-1/2 focus:border-2 rounded-r-full py-2 px-5 outline-none" type="text" placeholder="Last Name" value={lastname} />
                    </div>
                    <input onChange={ handleEmail } className="bg-zinc-300 w-full focus:border-2 rounded-full py-2 px-5 outline-none" type="email" placeholder="Email" value={email} />
                    <input onChange={ handlePassword} className="bg-zinc-300 w-full focus:border-2 rounded-full py-2 px-5 outline-none" type="password" placeholder="Password" value={password} />
                    <input onChange={ handleRePass } className="bg-zinc-300 w-full focus:border-2 rounded-full py-2 px-5 outline-none" type="password" placeholder="Confirm password" value={repassword} />
