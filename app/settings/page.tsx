    ...
    return (
        <div className="w-full min-h-screen pt-2 bg-evento-white text-black dark:bg-evento-black dark:text-white">
            ...
            <div className="flex flex-col w-full items-center gap-2 px-6 py-4">
                ...
                <button onClick={ () => handleUserPreferences() } className="py-2 px-4 w-3/4 rounded-md border-2 text-md bg-slate-700 dark:bg-evento-white text-white dark:text-evento-black hover:border-slate-700 hover:bg-slate-800 hover:text-white transition capitalize shadow-md">clear preferences</button>
